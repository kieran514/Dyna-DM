...
def save_checkpoint(epoch, save_freq, save_path, dispnet_state, ego_pose_state, obj_pose_state, initial_ego_pose_state, is_best, filename='checkpoint.pth.tar'):
    file_prefixes = ['dispnet', 'ego_pose', 'obj_pose', 'initial_ego_pose']
    states = [dispnet_state, ego_pose_state, obj_pose_state, initial_ego_pose_state]
