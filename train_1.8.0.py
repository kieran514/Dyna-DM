...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        train_loss, initial_inter, new_iter = train(args, train_loader, disp_net, ego_pose_net, ego_pose_net_initial, obj_pose_net, optimizer, args.epoch_size, logger, tf_writer, distribition) #scheduler
...
def train(args, train_loader, disp_net, ego_pose_net, ego_pose_net_initial, obj_pose_net, optimizer, epoch_size, logger, tf_writer, distribition): #schedule
