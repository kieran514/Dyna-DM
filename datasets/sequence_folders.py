'''
Reference: https://github.com/SeokjuLee/Insta-DM/blob/master/datasets/sequence_folders.py
'''
...
class SequenceFolder(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # pdb.set_trace()
        return tgt_img, ref_imgs, intrinsics, np.linalg.inv(intrinsics), tgt_insts, ref_insts, noc
